                    ...
                    <div className="flex flex-col items-center justify-center gap-4 mb-8 w-full max-w-[1200px] mx-auto">
                        <div className="w-full max-w-[540px]">
                            <div className="relative">
                                ...
                                <div className={`absolute bottom-0 right-0 h-8 w-8 flex items-center justify-center m-4 rounded-full ${textareaValue.trim() ? 'bg-black text-white cursor-pointer' : 'text-gray-light bg-gray-100 cursor-not-allowed'} hover:scale-110 transition-all duration-300`} onClick={handleSendPrompt}><EastIcon fontSize="small" /></div>
                            </div>
                            <div
